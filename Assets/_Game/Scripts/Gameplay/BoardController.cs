...
{
    /// <summary>
    /// Facade gameplay cho thao tác board ở M1.4.
    /// Bao gồm board core + queue + move availability.
    /// Chưa chứa mode-specific logic.
    /// </summary>
    public sealed class BoardController
    {
        ...
        public BoardController(int width, int height, ShapeSpawnPool shapeSpawnPool)
        {
            ...
            _blockQueueController = new BlockQueueController(spawnSystem, GameConstants.DefaultQueueSize);
        }
