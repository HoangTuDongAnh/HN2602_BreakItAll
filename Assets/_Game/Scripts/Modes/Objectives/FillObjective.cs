...
{
    /// <summary>
    /// Initial Fill objective implementation. It uses target pattern cells as the fill mask;
    /// provided-block and rotation rules are stored in level data and can be wired later.
    /// </summary>
    public sealed class FillObjective : IGameObjective
    {
        ...
        public FillObjective(bool requireUseAllProvidedBlocks)
        {
