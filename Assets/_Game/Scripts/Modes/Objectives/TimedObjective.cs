...
{
    /// <summary>
    /// Time level: dat target score truoc khi het gio.
    /// Day la level type duy nhat co timer va dung ScoreManager trong Arcade.
    /// </summary>
    public sealed class TimedObjective : IGameObjective
    {
        #region Fields
        ...
        #region Constructor
        public TimedObjective(int targetScore, bool failWhenTimeEnds = true)
        {
